...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="indexNonAdmin.php">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="indexNonAdmin.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Τοποθέτηση Παραγγελίας</span></a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="orderHistoryUser.php">Ιστορικό Παραγγελιών</a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="chartsNonAdmin.php">
